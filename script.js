...
sr.reveal('.pr_title, .location, .card-section', {origin: "top", interval: 200, delay: 400})
sr.reveal('.product_title, .product_p', {origin: "top", interval: 200, delay: 400})
sr.reveal('.product_btn', {origin: "top", interval: 200, delay: 400})
sr.reveal('.testride_banner', {origin: "top", interval: 200, delay: 400})
sr.reveal('.top_brands, .video', {origin: "top", interval: 200, delay: 500})
sr.reveal('.buy_product-title, .product_cards', {origin: "top", interval: 200, delay: 400})
sr.reveal('.testimonials_title, .testimonials_content', {origin: "top", interval: 200, delay: 500})
sr.reveal('.footer', {origin: "top", interval: 300, delay: 600})